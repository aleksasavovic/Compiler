...
public class ArrayAccessDesignator extends Designator {

    private DesignatorArray DesignatorArray;
    private Expr Expr;

    public ArrayAccessDesignator (DesignatorArray DesignatorArray, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ArrayAccessDesignator(\n");
