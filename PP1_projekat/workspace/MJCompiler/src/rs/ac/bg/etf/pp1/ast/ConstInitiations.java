...
public class ConstInitiations extends ConstInitList {

    private ConstInitList ConstInitList;
    private ConstInit ConstInit;

    public ConstInitiations (ConstInitList ConstInitList, ConstInit ConstInit) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstInitiations(\n");
