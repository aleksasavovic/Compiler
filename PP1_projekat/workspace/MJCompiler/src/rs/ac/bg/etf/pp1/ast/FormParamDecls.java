...
public class FormParamDecls extends FormParamList {

    private FormParamList FormParamList;
    private FormParamDecl FormParamDecl;

    public FormParamDecls (FormParamList FormParamList, FormParamDecl FormParamDecl) {
