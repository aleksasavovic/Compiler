...
public class SingleOptActParsWithParens extends OptActParsWithParens {

    private OptActPars OptActPars;

    public SingleOptActParsWithParens (OptActPars OptActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleOptActParsWithParens(\n");
